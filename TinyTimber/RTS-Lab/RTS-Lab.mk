...
$(IntermediateDirectory)/player.c$(ObjectSuffix): player.c $(IntermediateDirectory)/player.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/home/hanna/Documents/TinyTimber/TinyTimber/RTS-Lab/player.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/player.c$(ObjectSuffix) $(IncludePath)
